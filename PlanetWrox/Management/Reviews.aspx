...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="Id" DataSourceID="ReviewsSqlDataSource">
        <Columns>            
            <asp:HyperLinkField HeaderText="Title" DataTextField="Title" 
                                DataNavigateUrlFields="Id, Authorized" 
                                DataNavigateUrlFormatString="AddEditReviewHandCoded.aspx?Id={0}&Authorized={1}" />
    ...
    <a href="AddEditReviewHandCoded.aspx">Insert New Review</a><asp:SqlDataSource ID="ReviewsSqlDataSource" runat="server" 
